...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:Label ID="lblError" runat="server" style="z-index: 1; left: 669px; top: 366px; position: absolute"></asp:Label>
    <asp:Button ID="btnCancel" runat="server" style="z-index: 1; left: 818px; top: 310px; position: absolute; width: 80px;" Text="Cancel" OnClick="btnCancel_Click" />
    ...
    <asp:Button ID="btnSave" runat="server" style="z-index: 1; left: 975px; top: 310px; position: absolute; width: 80px;" Text="Save" OnClick="btnSave_Click" />
