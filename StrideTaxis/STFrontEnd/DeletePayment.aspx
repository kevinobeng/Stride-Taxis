...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
        <div style="height: 550px;">    
            ...
            <asp:Label ID="LabelDeletePayment" runat="server" style="z-index: 1; left: 564px; top: 190px; position: absolute; width: 496px" Text="Click Yes To Delete The Selected Payment, or No To Return To Payment.aspx"></asp:Label>
