...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:Label ID="lblDelete" runat="server" style="z-index: 1; top: 85px; position: absolute; left:515px" Text="Are You Sure You Want To Delete This Destination?"></asp:Label>
