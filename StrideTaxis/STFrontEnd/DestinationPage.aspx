...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:Label ID="lblError" runat="server" style="z-index: 1; left: 632px; top: 370px; position: absolute; " Text="Label"></asp:Label>
    <asp:Button ID="btnDelete" runat="server" style="z-index: 1; left: 653px; top: 316px; position: absolute" Text="Delete" OnClick="btnDelete_Click"/>
    <asp:Button ID="btnAdd" runat="server" style="z-index: 1; left: 604px; top: 316px; position: absolute" Text="Add" OnClick="btnAdd_Click" />
